...
get_accuracy_mtrx = function(results_datatable, tie_break_order) {
    ...
    get_tp = function(hand_coded_logical, machine_coded_logical) {
        ...
        for(i in 1:length(hand_coded_logical)) {
            if(hand_coded_logical[i] & machine_coded_logical[i]) out = out + 1
        }
        return(out)
    }
    
    get_fp = function(hand_coded_logical, machine_coded_logical) {
        # two logical vectors -> single integer value
    ...
    get_fn = function(hand_coded_logical, machine_coded_logical) {
        # two logical vectors -> single integer value
    ...
    get_machine_coded_logical = function(category, machine_coded_category) {
        # character/integer value and character vector -> logical vector
        # > get_machine_coded_logical(1, as.character(c(4, 5, 5, 3, 2)))
        # [1] FALSE FALSE FALSE FALSE FALSE
        # > get_machine_coded_logical(2, as.character(c(4, 5, 5, 3, 2)))
        # [1] FALSE FALSE FALSE FALSE TRUE
        # > get_machine_coded_logical(3, as.character(c(4, 5, 5, 3, 2)))
        # [1] FALSE FALSE FALSE TRUE FALSE
        # > get_machine_coded_logical(4, as.character(c(4, 5, 5, 3, 2)))
        # [1] TRUE FALSE FALSE FALSE FALSE
        # > get_machine_coded_logical(5, as.character(c(4, 5, 5, 3, 2)))
        # [1] FALSE TRUE TRUE FALSE FALSE        
        return(machine_coded_category==category)
    }
    
    get_machine_coded_category = function(matrix_of_algorithm_labels) {
    ...
    get_time_corr = function(hand_coded_logical, machine_coded_logical) {
        ...
        get_machine_coded_proportion_by_year = function(machine_coded_logical) {
            # logical vector -> numeric vector
            # > get_machine_coded_proportion_by_year(c(FALSE, FALSE, FALSE, FALSE, FALSE))
            # [1] 0 0            
            # > get_machine_coded_proportion_by_year(c(FALSE, FALSE, FALSE, FALSE, TRUE))
            # [1] 0 0.333333
            # > get_machine_coded_proportion_by_year(c(FALSE, FALSE, FALSE, TRUE, FALSE))
            # [1] 0 0.333333
            # > get_machine_coded_proportion_by_year(c(TRUE, FALSE, FALSE, FALSE, FALSE))
            # [1] 0.5 0
            # > get_machine_coded_proportion_by_year(c(FALSE, TRUE, TRUE, FALSE, FALSE))
            # [1] 0.5 0.333333
            
            machine_coded_logical_by_year = data.table(year=results_datatable$year, weight=results_datatable$weight, machine_coded_logical = machine_coded_logical)
            proportion_by_year = machine_coded_logical_by_year[ , sum(weight[machine_coded_logical])/sum(weight), by=year]
            setorder(proportion_by_year, year)
            return(proportion_by_year$V1)
        }
        
        hand_coded_proportion_by_year = get_hand_coded_proportion_by_year(hand_coded_logical)
        machine_coded_proportion_by_year = get_machine_coded_proportion_by_year(machine_coded_logical)
        
        return(cor(hand_coded_proportion_by_year, machine_coded_proportion_by_year))
    }
    ...
    hand_coded_logical = sapply(labels, get_hand_coded_logical, hand_codes_variable=results_datatable$label) # should return matrix with a column for each code
    matrix_of_algorithm_labels = get_matrix_of_algorithm_labels(results_datatable)
    machine_coded_category = get_machine_coded_category(matrix_of_algorithm_labels)
    machine_coded_logical = sapply(labels, get_machine_coded_logical, machine_coded_category)
    
    tp = sapply(labels, function(x) get_tp(hand_coded_logical[,x], machine_coded_logical[,x])) # should return a length-5 vector of counts
    fp = sapply(labels, function(x) get_fp(hand_coded_logical[,x], machine_coded_logical[,x])) # "
    fn = sapply(labels, function(x) get_fn(hand_coded_logical[,x], machine_coded_logical[,x])) # "
    ...
    trend_correlation = sapply(labels, function(x) get_time_corr(hand_coded_logical[,x], machine_coded_logical[,x]), USE.NAMES=FALSE)
...
#     avg_correlation = sum(trend_correlation*support)/sum(support)
    ...
    # But Marcel pointed out that we should use macro-averages
    ...
    sum_support = sum(support)
    avg_correlation = mean(trend_correlation)
